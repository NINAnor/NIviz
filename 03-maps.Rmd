...
The jerv (wolverine) data was downloaded using the `R/singleIndicator.R` script and the importDatasetApi() function,, and subsequntly the assembleNiObject() function, so now I can simply import it.
